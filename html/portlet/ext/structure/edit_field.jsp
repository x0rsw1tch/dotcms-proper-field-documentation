...
<div id="TabOne" dojoType="dijit.layout.ContentPane" title="Overview" >
	...
	<dl id="hintText" style="display:none">
		...
		<dd><textarea dojoType="dijit.form.SimpleTextarea" name="hint" rows="8" cols="52"><%= UtilMethods.isSet(fieldForm.getHint()) ? UtilMethods.webifyString(fieldForm.getHint()) : "" %></textarea>
		<!--<input type="text" dojoType="dijit.form.TextBox" name="hint" style="width:250px" value="<%= UtilMethods.isSet(fieldForm.getHint()) ? UtilMethods.webifyString(fieldForm.getHint()) : "" %>" /></dd>-->
	</dl>
	<!-- END Field Options -->
