...
/* ethode tomk: Field Hint Styles */
span.hintIcon {
    margin-left: 0.25rem;
}

div.contentlet-field-hint {
	clear: both;
	color: #24677b;
	font-weight: normal;
	font-style: italic;
...
div.contentlet-field-hint p {
	font-size: 13px;
}

div.contentlet-field-hint sub {
	font-size: 11px;
}
</style>
...
jQuery(document).ready(function () {
	jQuery("div[data-structname]").each(function() {
		getFieldDocumentation(jQuery(this), jQuery(this).data('structname'), jQuery(this).data('structfield'));
	});
});
</script>
